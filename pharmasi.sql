...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 03 avr. 2026 à 13:02
...
CREATE TABLE `visite` (
  ...
  `numero_visite_employe` int(11) DEFAULT NULL,
  `idProduit` int(11) DEFAULT NULL,
  `quantite_echantillon` int(11) DEFAULT NULL
...
INSERT INTO `visite` (`idVisite`, `id_employe`, `idPraticien`, `dateVisite`, `rapport`, `duree_visite`, `date_creation`, `numero_visite_employe`, `idProduit`, `quantite_echantillon`) VALUES
(1, 1, 2, '2026-02-09', 'qsdxc', 6, '2026-02-09 22:43:12', NULL, NULL, NULL),
(2, 3, 3, '2026-02-10', 'test view', NULL, '2026-02-10 12:10:57', NULL, NULL, NULL),
(3, 1, 2, '2026-03-10', 'ddsdqsd', 912, '2026-03-10 22:33:58', 1, NULL, NULL),
(4, 1, 2, '2026-03-10', 'dsqdqsd', 735, '2026-03-10 22:36:20', 2, NULL, NULL),
(5, 1, 2, '2026-03-10', 'sqdqsdqs', 1160, '2026-03-10 22:40:12', 3, 2, 8),
(6, 3, 2, '2026-03-10', 'sqSQsQS', NULL, '2026-03-10 22:41:58', 1, 2, NULL),
(7, 1, 3, '2026-04-01', 'dd', 923, '2026-04-01 13:31:28', 4, 2, 1),
(8, 1, 3, '2026-04-03', 'ff', 920, '2026-04-01 13:31:59', 5, 3, 3),
(9, 1, 3, '2026-04-01', 'test', 1005, '2026-04-01 13:32:35', 6, 3, 1),
(10, 1, 2, '2026-04-01', 'Test raport', 968, '2026-04-01 14:08:25', 7, 2, 3);

--
-- Déclencheurs `visite`
--
DELIMITER $$
CREATE TRIGGER `calcul_numero_visite` BEFORE INSERT ON `visite` FOR EACH ROW BEGIN
    DECLARE prochain_numero INT;
    
    
    SELECT COALESCE(MAX(numero_visite_employe), 0) + 1 INTO prochain_numero
    FROM visite
    WHERE id_employe = NEW.id_employe;
    
    
    SET NEW.numero_visite_employe = prochain_numero;
END
$$
DELIMITER ;
...
--
ALTER TABLE `visite`
  MODIFY `idVisite` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
ALTER TABLE `visite`
  ...
  ADD CONSTRAINT `visite_ibfk_3` FOREIGN KEY (`idProduit`) REFERENCES `produit` (`IdProduit`);
COMMIT;
